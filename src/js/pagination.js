...
window.addEventListener('DOMContentLoaded', function () {
	...
	const paginationAppend = document.querySelector(".pagination-wrap") //! ТОТ СЕЛЕКТОР В КОТОРЫЙ ПОЛОЖИМ Пагинация
	...
	const paginationButtons = new PaginationButton(20, 6);
